...
if __name__ == "__main__":
    ...
    cve_used = pd.read_csv('./data/1_3/cve_used.csv',index_col=False)
    functional_map = pd.read_csv('./data/1_3/functional_map.csv',index_col=False)
    functional_scores = pd.read_csv('./data/1_3/functional_scores.csv',index_col=False)
    risk_scores = pd.read_csv('./data/1_3/risk_scores.csv',index_col=False)
    network_graph = pd.read_csv('./data/1_3/network_graph.csv',index_col=False)
